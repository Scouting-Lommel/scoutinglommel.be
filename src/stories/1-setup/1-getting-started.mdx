...
For more information and detailed instructions, check out the [getting started docs on the GIT repo](https://github.com/Scouting-Lommel/scoutinglommel.be/blob/main/documentation/getting-started.md).
